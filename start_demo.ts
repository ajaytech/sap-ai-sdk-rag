...
async function runDemo() {
  ...
  try {
    const query1 = 'I have to create a website with ReactJS tell me which course is best for me my email is ajay.nist@gmail.com';
    
    const result = await example1_basicQuery(pipeline,query1,"openai/gpt-oss-120b");
    
    console.log('Original query:', result.query);
    console.log('Masked query:', result.maskedQuery);
